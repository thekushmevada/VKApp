...
public class vivin_custom_arrayadaptor4 extends ArrayAdapter<String> {
    String[] list;
    Context context;// we create this for giving context for toast

    public vivin_custom_arrayadaptor4(@NonNull Context context, int resource, @NonNull String[] list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(getContext()).inflate(R.layout.tab4_layout, parent, false);
